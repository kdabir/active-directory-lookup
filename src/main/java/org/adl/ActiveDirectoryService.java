...
/**
 * A stateless, thread-safe service. Logically it is singleton, but it is 
 * allowed to create 'new' using default constructor for ease of creation using
 * default semantics and integration with containers like spring without 
 * any special configuration.
 * <p>
 * Ideally user will never need to create instance of this bean. Depending on
